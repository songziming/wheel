...
#if 0
static inline PURE int isalnum(int c) {
    return (('0' <= c) && (c <= '9'))
        || (('A' <= c) && (c <= 'Z'))
        || (('a' <= c) && (c <= 'z'));
}

static inline PURE int isalpha(int c) {
    return (('A' <= c) && (c <= 'Z'))
        || (('a' <= c) && (c <= 'z'));
}

static inline PURE int iscntrl(int c) {
    return ((c < 0x20) || (0x7f == c));
}

static inline PURE int isgraph(int c) {
    return ((0x21 <= c) && (c <= 0x7e));
}

static inline PURE int islower(int c) {
    return (('a' <= c) && (c <= 'z'));
}

static inline PURE int isprint(int c) {
    return ((0x20 <= c) && (c <= 0x7e));
}

static inline PURE int ispunct(int c) {
...
static inline PURE int isspace(int c) {
    return ((0x09 <= c) && (c <= 0x0d))
        ||  (0x20 == c);
}

static inline PURE int isupper(int c) {
    return (('A' <= c) && (c <= 'Z'));
}

static inline PURE int isxdigit(int c) {
    return (('0' <= c) && (c <= '9'))
        || (('A' <= c) && (c <= 'F'))
        || (('a' <= c) && (c <= 'f'));
}

static inline PURE int tolower(int c) {
    return c | 0x20;
}
#endif
